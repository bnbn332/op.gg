  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      if (context.URL) {
        await axios
          .get(
            `${context.URL}summoner/v4/summoners/by-name/${props.match.params.username}${context.RiotKey}`
          )
          .then((res) => {
        ...
        axios
          .get(
            `${context.URL}spectator/v4/active-games/by-summoner/${sumid}${context.RiotKey}`
          )
          .then((res) => {
            setLive(res);
          })
        ...
        axios
          .get(
            `${context.URL}league/v4/entries/by-summoner/${sumid}${context.RiotKey}`
          )
          .then((res) => {
            setCommon({
              loading: true,
